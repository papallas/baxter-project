...
[Interaction](https://github.com/um10kh/baxter-project/tree/master/src/interaction/src) includes the code for loacting customers and the server for the voice recognition Android app.
...
3. Lastly, place the left gripper on level with the table and the right gripper above wherever the customer's sweet container is.
