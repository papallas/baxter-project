...
and ",redRequest," red sweets"
        ...
        while baxter.redGiven < redRequest:
            ...
            for i in range(0, len(redpoints)):
                ...
                baxter.move_and_pick_up_sweet(0, redangles[i], currpoint[0], currpoint[1], currpoint[2], page[0], page[1])
        ...
        while baxter.greenGiven < greenRequest:
            ...
            for i in range(0, len(greenpoints)):
                ...
                baxter.move_and_pick_up_sweet(1, greenangles[i], currpoint[0], currpoint[1], currpoint[2], page[0], page[1])
        ...
        while baxter.blueGiven < blueRequest:
            ...
            for i in range(0, len(bluepoints)):
                ...
                baxter.move_and_pick_up_sweet(2, blueangles[i], currpoint[0], currpoint[1], currpoint[2], page[0], page[1])
